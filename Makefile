...
# Drive: shares, volumes, blocks, devices, photos, shared-with-me, bookmarks
drive:
	$(MAKE) generate PACKAGE=drive TAGS="shares,volumes,blocks,devices,photos,sharedwithme,user-link-access,shared-bookmarks"
